...
theme.wallpaper                                 = theme.dir .. "/miguel-mitchell-da-silva-dark-sky-artstation.jpg"
theme.font                                      = "Fira Sans Semibold 10.5"
theme.fg_normal                                 = "#a0b2fa"
theme.fg_focus                                  = "#b0d6e2"
theme.fg_urgent                                 = "#CC9393"
theme.bg_normal                                 = "#0b0c14"
theme.bg_focus                                  = "#0b0c14"
theme.bg_urgent                                 = "#2a1f1e"
theme.border_width                              = dpi(1)
theme.border_normal                             = "#a0b2fa"
theme.border_focus                              = "#b0d6e2"
theme.border_marked                             = "#CC9393"
theme.taglist_fg_focus                          = "#b0d6e2"
theme.tasklist_bg_focus                         = "#0b0c14"
theme.tasklist_fg_focus                         = "#b0d6e2"
